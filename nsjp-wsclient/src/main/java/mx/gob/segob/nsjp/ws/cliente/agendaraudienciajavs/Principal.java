 ...
 * 2012-05-07T19:17:50.014-05:00
 * Generated source version: 2.4.1
 * 
 */
@WebServiceClient(name = "Principal", 
                  wsdlLocation = "http://10.11.81.77:49560/JAVS1/Principal.asmx?WSDL",
...
public class Principal extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://10.11.81.77:49560/JAVS1/Principal.asmx?WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Principal.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://10.11.81.77:49560/JAVS1/Principal.asmx?WSDL");
        }
        WSDL_LOCATION = url;
    }
