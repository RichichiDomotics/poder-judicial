...
/*
	...
	*/
	...
	function selectr(id){
		...
		$.updateWindowContent("iframewindowCarpAuditoria"+idWindowCarpetaAuditoriaVisitador,'<iframe src="<%= request.getContextPath() %>/BusquedaExpedienteSistTrad.do?abreenPenal=abrPenal&ingresoDenuncia='+ingresoDenuncia +'&idNumeroExpediente='+id+'&pantallaSolicitada='+pantallaSolicitada+'&idArea='+gIdDepartamento+'" width="100%" height="100%" />');

		//$.newWindow({id:"iframewindowCarpAuditoria"+idWindowCarpetaAuditoriaVisitador, statusBar: true, posx:0,posy:0,width:1430,height:670,title:"Expediente: ", type:"iframe"});
...
<div class="ui-layout-west">
	...
	<div class="content">
		<div id="accordionmenuprincipal">
			...
			<h3><a href="#" onclick="ocultaMuestraGrids('gridMandamientosJudiciales');"><img src="<%=request.getContextPath() %>/resources/images/icn_carpprincipal.png" id="botpenal" width="15" height="15">&nbsp;Mandamientos Judiciales</a></h3>
			<div>
...
<div class="ui-layout-north">
			...
			<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%"  height="100%">
				  <TBODY style="background: #fff;">
					  <TR>
					    ...
					    <TD width=301 align=left valign="middle" style="color:#51a651;">AUDITORIA</TD>
	...
	<ul class="toolbar">
		...
		<div id="menu_config">
			...
			<!-- <li onclick="generarDocumento();">Generar Documento&nbsp;<img src="<%= request.getContextPath() %>/resources/images/icn_dctowri.png" width="15" height="16"></li> -->
			<!-- <li>Solicitudes</li>-->
			<!-- <li>Guardar</li>-->
			<!--<li>config01</li>
			<li>config02</li>
