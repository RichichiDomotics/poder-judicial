  ...
  (function() {
	...
	*/
	...
	function guardaTeoria(){
		...
		$.ajax({
	    	...
	    	success: function(xml){
    			...
    			//});
	    		alert("Teoria del caso Guardada");
	    	}
		});		
		//alert(idul);
	}
	...
	function initDragDropScript()
	{
		...
		indiceEstructuradoId='<%=request.getParameter("idIndiceEstructurado")%>';
		var contenido="";
		$.ajax({
	    	type: 'POST',
		...
		<table  align="right" border="0">
			...
			<tr>
				<td>
					 ...
					 <div style="margin-top: 0; margin-bottom: auto; vertical-align: top;margin-right: auto; margin-left: auto; width: 513px; height:500px;">
