		...
		$(document).ready(function() {
			...
			*/ 						
			...
			jQuery("#gridObjsVehiculo").jqGrid({ 
				...
				datatype: "xml", 
				colNames:['Veh�culo','Folio Custodia de Evidencias', 'No. Casos Asociados'], 
			...
			jQuery("#gridObjsEquipoComputo").jqGrid({ 
				url:'local', 
				datatype: "xml", 
				colNames:['Equipo de C�mputo','Folio Custodia de Evidencias', 'No. Casos Asociados'], 
	...
	*/
	...
	function asignarAgenteMP(){
		...
		if(funcio != "-1"){
			...
			alertDinamico("Se asign� correctamente la Averiguaci�n previa");	
		}else{
		...
		if(usaeditor== "true"){			
			...
			else if(actividad=='<%= Actividades.SOLICITAR_ATENCION_PSICOLOGICA_A_LA_DIRECCION_DE_ATENCION_A_VICTIMAS.getValorId() %>')
			{
				...
				if(consultaTotalRelacionesDelitoPorTodos()>0)
				{
		            ...
		            $.updateWindowContent("iframewindowSolicitud",'<iframe src="<%= request.getContextPath() %>/solicitarAyudaPsicologicaUAVD.do?formaId='+formaID+'&idExpedienteop='+idExpedienteop+'&numeroCaso='+numeroCaso+'&numeroUnicoExpediente='+numeroExpediente+'&sistemaTradicional=1"    width="1140" height="550" />');
				}
				else
				{
					alertDinamico("Debe tener registrada la relaci�n de la v�ctima \n con el probable responsable y el delito");
				}
			}
					...
					if(existeDelitoGraveEnExpediente != ""){
						if( existeDelitoGraveEnExpediente == "false"){						
							if(existeProbableResponsableReincidente() == "false"){
								...
								if( excede == "null"){
									alert("Existe un problema con la media aritm�tica de los delitos");
								}else{
									if(excede == "true"){
										alert("La media aritm�tica de los delitos excede de lo permitido");
			    		    ...
			    		    $.updateWindowContent("iframewindowGenerarDocumento",'<iframe src="<%= request.getContextPath() %>/generarDocumentoSinCaso.do?formaId='+formaID+'&numeroUnicoExpediente='+numeroExpediente+'" width="1140" height="400" />');
								...
								alert("Existe probable responsable reincidente, no es posible enviar a la unidad de controversias");
						}
						else
	...
	/**FIN seleccion de actuacion de policia ministerial**/
		...
		*/
		...
		function cargaProbableResponsable(nombre,id){
			...
			$(row).remove();
			nombre=nombre+"- ";
			$('#tblProbableResponsable').append('<tr id="'+id+'"><td class="noSub" style="cursor:pointer;">&nbsp;&nbsp;&nbsp;<a id="consultarProbableResponsable" onclick="modificaProbableResponsable('+id+')">'+nombre+'<bean:message key="indiciado" /></a></td></tr>');
		...
		*/
		function eliminaProbableResponsableDeMenuIntermedio(id){
			...
			$(row).remove();
			alertDinamico("Se anul� exitosamente el involucrado");
		}
		...
		*/
		...
		function consultarProbResponsable(){
			...
			$.newWindow({id:"iframewindowConsultarProbResponsable" + idWindowConsultarProbResponsable, statusBar: true, posx:75,posy:30,width:1100,height:530,title:"Consultar Probable Responsable", type:"iframe"});
		...
		function creaNuevoProbResponsable() {
			...
			$.newWindow({id:"iframewindowIngresarProbResponsable" + idWindowIngresarProbResponsable, statusBar: true, posx:75,posy:30,width:1100,height:530,title:"Ingresar Probable Responsable", type:"iframe"});
		...
		function modificarProbResponsable(id) {
			idWindowIngresarProbResponsable++;
			var sistemaTrad = true;
			$.newWindow({id:"iframewindowModificarProbResponsable" + idWindowIngresarProbResponsable, statusBar: true, posx:75,posy:30,width:1100,height:530,title:"Ingresar Probable Responsable", type:"iframe"});
	...
	function muestraMenuIntermedio(abrePenal){
		...
		*/
		...
		function pliegoConsignacion() {
			...
			$.newWindow({id:"iframewindowAbrirteoria", statusBar: true, posx:20,posy:20,width:1390,height:600,title:"Pliego de Consignaci�n", type:"iframe"});
		...
		function lanzaCarpetaInvestigacionDefensoria() {
			$.newWindow({id:"iframewindowAbrirteoria", statusBar: true, posx:20,posy:20,width:310,height:231,title:"Enviar Averiguaci�n previa", type:"iframe"});
...
<div id="dialog-Alert" style="display: none">
	...
	<div id="tabs">
		...
		<ul>
			...
			<li class="tabTabsVisitaduria"><a href="#tabs-16">Visitaduria</a></li>
			...
			<li class="tabTabsPolMin"><a href="#tabs-9" onclick="">Policia ministerial</a></li>
			<li class="tabTabsCadCus"><a href="#tabs-10" onclick="gridCustodia()">Custodia de Evidencias</a></li>
			<li class="tabTabsAudiencias"><a href="#tabs-12">Audiencias</a></li>
			<li class="tabTabsNotas"><a href="#tabs-5">Notas</a></li>
			<li class="tabTabsAlertas"><a href="#tabs-14" onclick="alertas()">Bitacora de alarmas</a></li>
		</ul>
				...
				<div id="tabschild16-1">
					<div style="width: 1042px; height: 490px;" class="back_hechos" ><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<table width="50%">
							<tr>
								<td width="10%"></td>
								<td><b>Nombre del MP due�o del expediente auditado : </b>
								</td>
		...
		<div id="tabs-4" class="tabTabsObjs">
			...
			<div id="tabschild4" class="tabs-bottom">
				...
				<div id="tabschild4-10">
					<table width="25%" cellpadding="0" cellspacing="0">
						<tr>
							<td>&nbsp;&nbsp;&nbsp;<input type="button" id="nuevoInmueble" class="btn_Generico" value="Ingreso nuevo"/></td>
						</tr>
					</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
  ...
  <tr>
    ...
    <td id="imgQuienDetuvo" width="15"><img title="Contiene mas registros" width="10px" src='<%= request.getContextPath() %>/resources/images/add.png'></td>
			  ...
			  <tr>
			    <td align="right"><span id="spanGralUI">Agencia del Ministerio P�blico: </span><span id="spanInfoGralUI"></span></td>
			    <td>&nbsp;</td>
	...
	<!--COMIENZAN TABS INFERIORES DE ACTUACIONES-->
		<div id="tabs-7" class="tabTabsAcciones">		
			...
			<tr>
				...
				<td>
					<button value="Elaborar teoria del caso" id="idTeoriaCaso" class="btn_Generico" onclick="abreTeoria()">Teoria del Caso</button>
				</td>
				<td>
			...
			<tr>
				<td id="tdCbxAjentesCoorJAR1">Facilitadores:</td>
				<td id="tdCbxAjentesCoorJAR"><select id="cbxAjentesCoorJAR" style="width:470px">
					<option value="-1">-Seleccione-</option>
					
				</select></td>
				<td id="tdCbxAjentesCoorUI1">Agentes:</td>
				<td id="tdCbxAjentesCoorUI"><select id="cbxAjentesCoorUI" style="width:470px">
					<option value="-1">-Seleccione-</option>
			...
			<td > 
				...
				<td>
				<button value="Enviar de Investigacion" class="btn_Generico" onclick="lanzaCarpetaInvestigacionDefensoria()">Enviar Carpeta de Investigacion</button>
				</td>
			</tr>
		<!-- <tr>
...
<!--TERMINAN TABS INFERIORES DE ACTUACIONES-->
		...
		<div id="tabs-10" class="tabTabsCadCus">
				 <input type="button" class="btn_Generico" id="btnCadCusNuevaCadCus" style="width: 220px;" value="Crear nueva custodia de evidencias"/>
				 <input type="button" class="btn_Generico" id="btnCadCusConsultaCadCus" style="width: 200px;" value="Consultar custodia de evidencias"/>    
  				 <input type="button" class="btn_Generico" id="btnCadCusRegEslabones" style="width: 200px;" value="Registrar eslabones"/> 
  				 <input type="button" class="btn_Generico" id="btnCadCusRepEvidencias" style="width: 200px;" style="width: 250px;" value="Reporte de evidencias"/> 
  				 <input type="button" class="btn_Generico" id="btnCadCusElabOficio" style="width: 250px;" value="Elaborar oficio para fijaci�n y preservaci�n"/>  
		...
		<br>
			...
			<tr>
				...
				<td>
					<input type="radio" name="noImputado" id="imputadoNo" onclick="validaCriterios()"> El <bean:message key="indiciado" /> sufri� da�os graves.
				</td>
			</tr>
			<tr>
				<td>
	...
	$( "#dialogImpugnacionARchivo-confirm" ).dialog({
		...
		buttons: {
			"Aceptar": function() {
				...
				$.newWindow({id:"iframewindowSolicitarAudiencia", statusBar: true, posx:20,posy:20,width:750,height:530,title:"Solicitar Ayuda", type:"iframe"});
