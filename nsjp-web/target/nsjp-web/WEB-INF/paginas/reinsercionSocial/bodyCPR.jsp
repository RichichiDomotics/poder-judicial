	...
	<div class="ui-layout-west">
		...
		<div class="content">
			<div id="accordionmenuprincipal">
				...
				<div></div>
				<h3>
					<a href="javascript:void(0)" onclick="crearVentana('idVentanaAdminProgramas', 'Administrar Programas De Reinserción Social', '/administarProgramas.do', ''); "> <img
						src="<%=request.getContextPath()%>/resources/images/icn_carpprincipal.png"
						id="botpenal" width="15" height="15">&nbsp;Administrar Programas</a>
				</h3>		
				<div></div>								
			</div>
		</div>
