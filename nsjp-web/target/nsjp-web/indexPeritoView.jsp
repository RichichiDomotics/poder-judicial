   ...
   */
   function cargaGridAsignacionesRecibidasEnProceso(){
	...
	function mostrarVisorAtencionSolicitudesPericiales(rowId){
		...
		$.newWindow({id:"iframewindowVisorAtnSolPer"+idWindowVisorAntencionSolPer, statusBar: true, posx:150,posy:30,width:1200,height:600,title:"Atencion solicitudes periciales", type:"iframe"});
...
<h6><a href="#" id="" onclick="visorLeyesCodigos()">Consultar Leyes y C&oacute;digos</a></h6>
			...
			<!--h4><a href="#" id="" onclick="visorLeyesCodigos()">Consultar Leyes y C&oacute;digos</a></h4>
				<div>
			...
			<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%"  height="100%">
				  <TBODY style="background: #fff;">
					  <TR>
					    ...
					    <TD width=301 align=left valign="middle" style="color:#51a651;">PERITO FISCALIA GENERAL</TD>
