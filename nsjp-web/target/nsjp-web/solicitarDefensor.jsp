				...
				<div id="tabsconsultaprincipal-2">
					<table width="100%" border="0" height="90%">
						<tr>
							...
							<td>
								<input type="text" class="" size="50" maxlength="50" id="solDeSSPNumeroIPH"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" size="50" maxlength="50"	id="solDeSSPNombreDetenido"  />
							</td>
						</tr>
						<tr>
							<td align="right">
								Fecha de Detenci&oacute;n:
							</td>
							<td>
								<input type="text" size="50" maxlength="50" id="solDeSSPFechaDetencion" />
							</td>
						</tr>
						<tr>
							<td align="right">
								Hora de Detenci&oacute;n:
							</td>
							<td>
								<input type="text" size="50" maxlength="13"	id="solDeSSPHoraDetencion" />
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input type="text" size="50" maxlength="13"	id="solDeSSPDelito" />
							</td>
						</tr>
						<tr>
