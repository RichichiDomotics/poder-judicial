...
function creaVentanaAsignacionPrograma() {
	...
	if (sentenciaId) { 
		customVentana("iframewindowExpedietesPenaPrivativa", "Asignar Programa de Reinserci&oacute;n Social", "/asignarProgramaRS.do", "?sentenciaId="+sentenciaId);
	} else { 
...
function creaVentanaAcumulacionPuntos() {
	...
	var sentenciaId = jQuery("#gridExpedientesPorEstatus").jqGrid('getGridParam','selrow'); 
	if (sentenciaId) { 
		customVentana("iframewindowExpedietesPenaPrivativa", "Acumulaci&oacute;n de puntos", "/administracionAcumulacionPuntos.do", "?sentenciaId="+sentenciaId);
	} else { 
	...
	<div class="ui-layout-west">
		...
		<div class="content">
			<div id="accordionmenuprincipal">
				...
				<h3>
					<a href="javascript:void(0)" onclick="creaVentanaAsignacionPrograma()"> 
						<img src="<%=request.getContextPath()%>/resources/images/icn_carpprincipal.png"
							id="botpenal" width="15" height="15">&nbsp;Asignar Programas
					</a>
				</h3>
				<div></div>
				<h3>
					<a href="javascript:void(0)" onclick="creaVentanaActosBuenaConducta()"> 
						<img src="<%=request.getContextPath()%>/resources/images/icn_carpprincipal.png"
							id="botpenal" width="15" height="15">&nbsp;Actos de buena conducta
					</a>
				</h3>
				<div></div>
				<h3>
					<a href="javascript:void(0)" onclick="creaVentanaAcumulacionPuntos()"> 
						<img src="<%=request.getContextPath()%>/resources/images/icn_carpprincipal.png"
							id="botpenal" width="15" height="15">&nbsp;Programas de recompensas
					</a>
				</h3>
				<div></div>
				<h3>
				...
				<h3>
					<a href="javascript:void(0)" onclick="creaVentanaDetenidos(-1);"> <img
						src="<%=request.getContextPath()%>/resources/images/icn_carpprincipal.png"
						id="botpenal" width="15" height="15">&nbsp;Detenidos</a>
				</h3>
	...
	<div id="dialog-validarSentenciaIdAP" title="Error de validaci&oacute;n">
		<p>
		Para acumular los actos de buena conducta de una sentencia, es necesario seleccionar la sentencia de la cual se acumular&aacute;n 
		los actos de buena conducta asociados. <br/>
		Por favor seleccione un registro de la tabla de sentencias disponibles.
		</p>
	</div>