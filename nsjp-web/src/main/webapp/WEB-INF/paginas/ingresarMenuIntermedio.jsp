	...
	*/
	...
	function canalizarInvestigadoresSinRelaciones(actividad,estatusId,titulo, formaID, numeroExpediente){
		...
		function abreVentanaAdjuntarDocumento(tipo){
			...
			$.updateWindowContent("iframewindowAdjuntarDocumento",'<iframe src="<%=request.getContextPath()%>/adjuntarDocumento.do?idExpediente='+ idExpedienteop +'&numeroExpediente='+numeroExpediente+'&tipo='+tipo+'" width="308" height="165" />');
		}
	...
	/**FIN seleccion de actuacion de policia ministerial**/
		...
		*/
		function eliminaProbableResponsableDeMenuIntermedio(id){
			...
			var texto = "Se anul\u00f3 exitosamente el " + etiquetaProbable;
...
<div id="dialog-Alert" style="display: none">
	...
	<div id="tabs">
		...
		<ul>
			<li class="tabTabsGrals"><a href="#tabs-6" onclick="datosGenerales();existenAmparosEnExpediente()">Resumen</a></li>
			...
			<div id="tabschild" class="tabs-bottom">
				...
				<div style="width: 1042px; height: 490px;" class="back_hechos">
					<table width="25%" cellpadding="0" cellspacing="0" id="tblVictima" style="padding: .5cm;">
						<tr>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="nuevaVictima"><input type="button" class="btn_Generico" value="Ingresar Victima"/></a></td>
						</tr>
		...
		<div id="tabs-6" class="fondoClaroAp">
			...
			<table width="1042px"  height="490px" border="0" cellspacing="0" cellpadding="0" class="back_hechos">
			  ...
			  <tr style="border-bottom-style: solid; border: 1;background-image:">
			    <td width="238" style="font-size:14px; background-color:" align="right"><strong>Estatus del Expediente:</strong>&nbsp;<label id="estatusExpe"></label></td>
			  ...
			  <tr>
			    <td colspan="6" align="left">&nbsp;&nbsp;&nbsp;&nbsp;<label id="origenNumeroExpediente"></label></td>			    
		      </tr>
			  <tr valign="top">
			    <td align="right"></td>
			    <td></td>
		...
		<div id="tabs-7" class="tabTabsAcciones">		
			<div id="tabschild7" class="tabs-bottom">
				<ul>
					...
					<li><a href="#tabschild7-2">Relacionar Informaci&oacute;n del expediente</a></li>
				</ul>				
				<div id="tabschild7-1">					
				...
				<table width="820" border="0" cellspacing="0" cellpadding="0" id="tablaAcuseNoPenal">
					...
					<tr>
						...
						<td>
								<table>
									<tr>
										<td>
												<button value="Elaborar teoria del caso" id="idTeoriaCaso" class="btn_Generico" onclick="abreTeoria()" style="width: 100%;">Elaborar teoria del caso</button>
										</td>
									</tr>
					...
					<!-- aqui iba el tr de enviar carpeta de investigacion -->
...
<!--TERMINAN TABS INFERIORES DE ACTUACIONES-->
				...
				<div id="tabschild9-1">					
					<table width="800" border="0" cellspacing="0" cellpadding="0" id="">
						<tr>
							...
							<td>
								<input type="button" id="idInvestiga" onclick="abreLineasInvestiga()" value="Iniciar Investigacion" class="btn_Generico"/>
							</td>
							<td>
							</td>
						</tr>
		...
		<div id="tabs-10" class="tabTabsCadCus">
				 <input type="button" class="btn_Generico" id="btnCadCusNuevaCadCus" style="width: 220px;" value="Crear nueva cadena de custodia"/><br/><br/>
				 <input type="button" class="btn_Generico" id="btnCadCusConsultaCadCus" style="width: 200px;" value="Consultar cadena de custodia"/><br/><br/>    
  				 <input type="button" class="btn_Generico" id="btnCadCusRegEslabones" style="width: 200px;" value="Registrar eslabones"/> <br/><br/>
  				 <input type="button" class="btn_Generico" id="btnCadCusRepEvidencias" style="width: 200px;" style="width: 250px;" value="Reporte de evidencias"/> <br/><br/>
  				 <input type="button" class="btn_Generico" id="btnCadCusElabOficio" style="width: 250px;" value="Elaborar oficio para fijacion y preservacion"/><br/><br/>
		...
		<br>
			...
			<tr>
				...
				<tr><td>
					...
					<td>
					<input type="button" id="btnTranscripcionAudiencia" value="Transcripcion de audiencia" class="btn_Generico">
					</td>
					</tr>
					</table>
				</td>
		...
		<br>
			...
			<tr>
				...
				<td>
					<input type="button"  id="btnTurnarInpugna" onclick="dialigoImpugnacion()" value="Turnar inpugnacion de criterio de oportunidad" class="btn_Generico">
				</td>
			</tr>
			</table>
		</div>
	...
	<div id="dialogDictamen-confirm" title="Criterio de Opotunidad Envio de Dictamen " >
		<p align="left">
			&iquest;Desea enviar el dictamen de criterio de oportunidad?
		</p>
	</div>
	<!-- DIV para el dialogo de inpugnacion de criterio -->
	<div id="dialogImpugnacion-confirm" title="Criterio de Opotunidad Impugnacion " >
		<p align="left">
			&iquest;Desea impugnar el criterio de oportunidad?
		</p>
	</div>
	<!-- DIV para el dialogo de inpugnacion de criterio para archivo -->
	<div id="dialogImpugnacionARchivo-confirm" title="Criterio de Opotunidad Impugnacion " >
		<p align="left">
