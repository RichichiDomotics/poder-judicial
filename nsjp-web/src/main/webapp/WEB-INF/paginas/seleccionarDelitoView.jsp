	...
	<table border="0"  width="1500px">
		...
		<tr>
			...
			<td valign="top" width="10%">
				...
				<b> <span id="leyendaNingunDelitoGrave">Si no hay reincidencia por parte del probable responsable,<br/> 
				se debe canalizar a la Unidad de Solución de Controversias</span> </b>
			</td>
