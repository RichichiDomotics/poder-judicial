...
<body>
	...
	<table align="center" border="0" width="510px" height="50%">
		<tr><!-- MENU -->
			<td>
	...
	<div id="dialog-confirmSeleccionarDestinatario" title="Seleccionar Destinatario: ">
	  <div id="seleccionarDestinatario">
	    <label>
	      <input type="radio" name="TipoUsuario" value="1" id="TipoUsuario_0" onClick="$('#tblUsuarioExterno').hide();$('#tblUsuarioSistema').show();">
