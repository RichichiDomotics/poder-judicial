		...
		function cargaGridSolicitudesDeAudioVideo(estatusSolicitado){
			...
			if(primeraVezGridTranscripciones == true){
				jQuery("#gridDetalleFrmPrincipal").jqGrid({ 
					...
					colModel:[ 	{name:'numCaso',index:'numCaso', width:180}, 
								{name:'numCausa',index:'numCausa', width:180},
								{name:'fechHoraSol',index:'fechHoraSol', width:100},
								{name:'solicitante',index:'solicitante', width:150},
				...
				$("#gview_gridDetalleFrmPrincipal .ui-jqgrid-bdiv").css('height', '455px');
		...
		<div id="accordionmenuprincipal">
			...
			<div>			
				 <ul id="seccion0tree" class="filetree">
					<li class="closed" ><span class="file" onclick="cargaGridSolicitudesDeAudioVideo('delDia');">Del Día</span></li>
			...
			<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%"  height="100%">
				  <TBODY style="background: #fff;">
					  <TR>
					    ...
					    <TD width=301 align=left valign="middle" style="color:#51a651;">ENCARGADO DE INFORMATICA</TD>
