...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		*/
		...
		jQuery("#gridDetalleResolutivaAudiencia").jqGrid({ 
		 ...
		 $("#gview_ gridDetalleResolutivaAudiencia .ui-jqgrid-bdiv").css('height', '600px');	
	...
	*/
	...
	function buscaAudienciaNo() {
		$.newWindow({id:"iframewindowGenerarDocumento", statusBar: true, posx:200,posy:50,width:650,height:400,title:"Tipo de Busqueda de Audiencia", type:"iframe"});
	    $.updateWindowContent("iframewindowGenerarDocumento",'<iframe src="<%=request.getContextPath()%>/buscaCarpetaEjecucionJSP.do" width="650" height="400" />');
	...
	function mostrarVentanaTranscripcionAdudiencia(rowid){
		...
		$.newWindow({id:"iframewindowTranscripcionAdudiencia" + idWindowTranscripcionAdudiencia, statusBar: true, posx:200,posy:50,width:1050,height:600,title:"Solicitud de Transcripci&oacute;n de Audiencia", type:"iframe"});
...
<h3><a id="bAudienciaPJRMJ" href="#">Buscar Audiencia</a></h3>
<div><!--			
...
<table width="100%" height="100%" border="0" cellspacing="0"
	...
	<tr>
		...
		<td width="296" align="center" style="font-size: 15px;"><span></span>Mandamientos Judiciales</td>
