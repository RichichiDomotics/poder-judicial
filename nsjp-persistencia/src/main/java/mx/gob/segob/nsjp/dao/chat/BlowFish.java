...
public class BlowFish {
    ...
    public static void main(String[] args) {
		...
		System.out.println("adin encript:"+blowFish.encryptString("admin"));
		System.out.println(blowFish.decryptString("b7b77c43fcf66a3989e1b296a9efbf61d8a65adb3ca32310"));
	}
}
